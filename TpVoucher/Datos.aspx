...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ContentTemplate>
        <div class="text-center">
            <div class="card p-4 mt-4" style="width: 40rem;">
                <div class="form-group mb-3 text-center">
                    <label for="TextBox1" class="form-label">DNI</label>
                    <asp:TextBox ID="datos_dni" runat="server" CssClass="form-control mx-auto" style="width: 80%;" />
                </div>
            ...
            <div class="card p-4 mt-4" style="width: 40rem;">
                ...
                <div class="form-group mb-3">
                    ...
                    <asp:TextBox ID="datos_nombre" runat="server" CssClass="form-control mx-auto" style="width: 80%;" />
                ...
                <div class="form-group mb-3">
                    ...
                    <asp:TextBox ID="datos_apellido" runat="server" CssClass="form-control mx-auto" style="width: 80%;" />
                ...
                <div class="form-group mb-3">
                    ...
                    <asp:TextBox ID="datos_mail" runat="server" CssClass="form-control mx-auto" style="width: 80%;" TextMode="Email" />
                ...
                <div class="form-group mb-3">
                    ...
                    <asp:TextBox ID="datos_direccion" runat="server" CssClass="form-control mx-auto" style="width: 80%;" />
                ...
                <div class="form-group mb-3">
                    ...
                    <asp:TextBox ID="datos_ciudad" runat="server" CssClass="form-control mx-auto" style="width: 80%;" />
                ...
                <div class="form-group mb-3">
                    ...
                    <asp:TextBox ID="datos_cp" runat="server" CssClass="form-control mx-auto" style="width: 80%;" />
